            ...
            <head>
                ...
                <style>
                    ...
                    .download-message {
                        ...
                        font-size: 14px;
                        color: #4CAF50;
                        display: none; /* Sembunyikan pesan ini secara default */
                    }
                </style>
                <script>
                    function showDownloadMessage() {
                        document.getElementById('download-message').style.display = 'block'; // Tampilkan pesan unduhan
                    }
                </script>
            </head>
            <body>
                <div class='message-box'>
                    ...
                    <div class='button-group'> <!-- Button group for horizontal layout -->
                        <a href='index.php'>Kembali</a>
                        <a href='cetak_invoice.php?code=$unique_code' target='_blank' onclick='showDownloadMessage()'>Cetak Invoice</a>
                    </div>
                    <div id='download-message' class='download-message'>Invoice Anda telah terunduh. Silakan periksa folder unduhan Anda.</div>
                </div>
            </body>
            </html>";
