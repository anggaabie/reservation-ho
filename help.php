...
.content {
    ...
    <script defer>
        ...
        function showMessage() {
            ...
            setTimeout(function() {
                messageElement.style.display = 'none'; // Sembunyikan pesan setelah 3 detik
                // Hapus parameter status dari URL tanpa merefresh halaman
                window.history.replaceState(null, null, window.location.pathname);
            }, 3000);
        }

        // Mengecek apakah status sukses dari URL
        window.onload = function() {
            var status = '<?php echo $status; ?>';
            if (status === 'sukses') {
                showMessage(); // Tampilkan pesan jika status adalah sukses
            }
        };
    </script>
</head>
<body>
    ...
    <main>
        <!-- Pesan sukses hanya tampil jika form berhasil dikirim -->
        <div id="message" class="message">Laporan anda telah terkirim!</div>
