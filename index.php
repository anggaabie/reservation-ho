...
<header>
    ...
    <div class="sidebar">
    <ul>
    <li><a href="index.php" class="<?php echo $current_page == 'index.php' ? 'active' : ''; ?>">Home</a></li><!-- Beranda selalu ditampilkan -->
        <?php if (isset($_SESSION['username'])): ?>  <!-- Untuk pengguna yang sudah login -->
    ...
    <div class="notification"></div>
        ...
        echo '<p>Harga: <strong>Rp ' . number_format($row['price'], 0, ',', '.') . '</strong>/malam</p>'; // Menebalkan harga
...
?>
    ...
    <div class="modal-content">
        ...
        <?php if (isset($_SESSION['user_data'])): ?>
            <p><strong>Nama:</strong> <?php echo htmlspecialchars($_SESSION['user_data']['name']); ?></p>
            <p><strong>Tanggal Lahir:</strong> <?php echo htmlspecialchars($_SESSION['user_data']['birthdate']); ?></p>
            <p><strong>Umur:</strong> <?php echo htmlspecialchars($_SESSION['user_data']['age']); ?></p>
            <p><strong>Alamat:</strong> <?php echo htmlspecialchars($_SESSION['user_data']['address']); ?></p>
        <?php else: ?>
            <p>Data diri Anda belum lengkap. Silakan lengkapi data diri Anda.</p>
            <p><strong>Disarankan untuk melengkapi:</strong></p>
            <ul>
                <li>Nama</li>
                <li>Tanggal Lahir</li>
                <li>Umur</li>
